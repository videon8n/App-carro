...
// Usadas quando voce quer ver a UI funcionando sem depender de scraping
// (ex: rodando em Replit/Railway onde os anti-bots bloqueiam IP de datacenter).
//
// Sao dados realistas de carros fictícios da regiao de Campinas, com score
// pre-calculado, red flags e preco FIPE de referencia.

const ph = (label) =>
  `https://placehold.co/600x400/171a21/4ea1ff?text=${encodeURIComponent(label)}`;
...
export const DEMO_CARS = [
  {
    ...
    photoUrl: ph('Toyota Corolla 2020'),
    fipePrice: 109500,
    fipeDelta: -0.0968,
    score: 92,
    reason:
  ...
  },
  {
    ...
    photoUrl: ph('Chevrolet Onix 2019'),
    fipePrice: 68500,
    fipeDelta: -0.0817,
    score: 32,
    reason:
    ...
    redFlags: [
      ...
      'Foi Uber (alta quilometragem de uso intenso)',
      'KM alta para o ano',
    ],
